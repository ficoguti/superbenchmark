...
class PytorchLlama(PytorchBase):
    ...
    def add_parser_arguments(self):
        ...
        Llama model reference: https://huggingface.co/docs/transformers/model_doc/llama
        """
        ...
        self._parser.add_argument(
            '--intermediate_size', type=int, default=11008, required=False, help='Intermediate size.'
        )
        self._parser.add_argument(
            '--num_key_value_heads', type=int, default=None, required=False, help='The number of attention heads.'
        )
...
# Parameters for Llama benchmark are omitted because it is a gated repo.
# Request access to repo and then add parameters to use it. Relevant config files are listed below.

# Register Llama benchmark with 7B parameters.
# Reference: https://huggingface.co/meta-llama/Llama-2-7b-hf/blob/main/config.json
...
# Register Llama benchmark with 13B parameters.
# Reference: https://huggingface.co/meta-llama/Llama-2-13b-hf/blob/main/config.json
BenchmarkRegistry.register_benchmark(
    'pytorch-llama-13b',
    PytorchLlama,
    parameters=''
...
# Register Llama benchmark with 70B parameters.
# Reference: https://huggingface.co/meta-llama/Llama-2-70b-hf/blob/main/config.json
BenchmarkRegistry.register_benchmark(
    'pytorch-llama-70b',
    PytorchLlama,
    parameters=
